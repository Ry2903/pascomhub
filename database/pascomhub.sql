...
CREATE TABLE subhabilidade (
    ...
    nome enum('Fotos Profissionais', 'Fotos com celular', 'Câmera Móvel', 'Câmera Central', 'OBS', 'Feedbacks', 'Post Fotos e Homilia') NOT NULL,
...
CREATE TABLE userhabil (
    ...
    subhabil enum('Fotos Profissionais', 'Fotos com celular', 'Câmera Móvel', 'Câmera Central', 'OBS', 'Feedbacks', '07h30', '09h30', '19h', 'Post Fotos e Homilia') NULL,
